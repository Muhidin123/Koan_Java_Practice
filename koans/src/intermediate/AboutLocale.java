...
public class AboutLocale {
    ...
    public void localizedOutputOfDates() {
        ...
        Locale localeBIH = new Locale("BIH"); // Japan
        ...
        DateFormat dateformatBIH = DateFormat.getDateInstance(DateFormat.FULL, localeBIH);


        // Well if you don't know how to type these characters, try "de", "it" or "us" ;-)
        assertEquals(dateformatJA.format(date), "2011年4月3日日曜日");
        assertEquals(dateformatUS.format(date), "2011 Apr 3, Sun");
        assertEquals(dateformatBIH.format(date), "2011 Apr 3, Sun");
